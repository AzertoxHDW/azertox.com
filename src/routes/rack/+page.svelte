<script lang="ts">
    ...
    import { rackDevices, TOTAL_U_SLOTS, U_HEIGHT_PX, type RackDevice, type RackDeviceFaceplate } from "$lib/rack-data";
      ...
      <Card class="px-4 py-3 shadow-md">
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <div class="text-lg font-bold">{rackDevices.reduce((sum, d) => sum + d.uHeight, 0)}/{TOTAL_U_SLOTS}U</div>
          </div>
        </div>
      </Card>
      <Card class="px-4 py-3 shadow-md">
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <div class="text-lg font-bold">{rackDevices.filter(d => d.status === 'Online').length}/{rackDevices.length}</div>
          </div>
        </div>
      </Card>
      <Card class="px-4 py-3 shadow-md">
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <div class="text-lg font-bold">{new Set(rackDevices.map(d => d.type)).size}</div>
          </div>
        </div>
      </Card>
    </div>
